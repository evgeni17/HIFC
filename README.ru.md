...
* **HIFC IFC Import** читает IFC2X3, IFC4 и IFC4X3. На выходе — один packed-примитив на элемент (или обычные полигоны)
  с атрибутами: `path`, GUID, класс, этаж, материал, цвет и все наборы свойств.
